...
/**
 * Verifies whether the Group level Favorite is persistent between Category and Search pages to PIP 
 * for guest user.
 */
@Category(FavoritesArea.class)
public class GuestUserFavoritesPersistenceAtGroupLevelRegression extends AbstractTest {

    /**
     * Verifies whether the Group level Favorite is persistent between Shop to Simple PIP page for a guest user.
     * Test case ID - RGSN-38021, RGSN-38680
     */
    @Test
    @TestRail(id = "98433")
    public void testSimplePipPageWhenGuestUserFavoriteAnItemViaShopPageExpectGroupLevelFavorites() {
    ...
    /**
     * Verifies whether the Group level Favorite is persistent between Shop to Guided PIP page for a guest user.
     * Test case ID - RGSN-38021, RGSN-38680
     */
    @Test
    @TestRail(id = "98435")
    public void testGuidedPipPageWhenGuestUserFavoriteAnItemViaShopPageExpectGroupLevelFavorites() {
     ...
     * to Simple PIP page for a guest user.
     * Test case ID - RGSN-38147, RGSN-38680
     */
    @Test
    @TestRail(id = "98440")
    public void testSimplePipPageWhenGuestUserFavoriteAnItemViaSearchResultsPageExpectGroupLevelFavorites() {
    ...
    /**
     * Verifies whether the Group level Favorite is persistent between Search Result Page 
     * to Guided PIP page for a guest user.
     * Test case ID - RGSN-38147, RGSN-38680
     */
    @Test
    @TestRail(id = "98441")
    public void testGuidedPipPageWhenGuestUserFavoriteAnItemViaSearchResultsPageExpectGroupLevelFavorites() {
